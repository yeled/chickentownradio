...
use constant STREAM_SERVER_URL => "http://chickentownradio.co.uk:8000" ;
use constant STREAM_LIVE => "Chicken Town LIVE" ;
use constant STREAM_RECORDED => "Chicken Town Radio" ;
use constant RRD_FILE => "/home/yeled/ez/rrdtool/stream.rrd" ;
use LWP::Simple ;
use HTML::Parser ;
use RRDTool::OO ;
...
sub text_trigger {
  ...
  if (( $_[0] =~ STREAM_LIVE ) || ( $_[0] =~ STREAM_RECORDED )) { # Icecast serves multiple streams. Is this our radio station?
    $station_dataspace = 1 ;
    return ;
  }
